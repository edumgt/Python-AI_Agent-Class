# project016 App (Prj_AIOpsObservability)

- Track: `프로젝트-4`
- Topic: `AIOps 관측성·이상탐지·자동복구 · 단계 1/5 입문 이해`
- Curriculum Link: `project/Prj_AIOpsObservability/project016/project016.md`
...
## Local Run
```bash
cd projectApps/Prj_AIOpsObservability/project016
python -m venv .venv
