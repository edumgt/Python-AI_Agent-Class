# project003 App (Prj_DevOpsKickoff)

- Track: `프로젝트-1`
- Topic: `DevOps 프로젝트 착수와 요구사항 정의 · 단계 3/5 응용 확장`
- Curriculum Link: `project/Prj_DevOpsKickoff/project003/project003.md`
...
## Local Run
```bash
cd projectApps/Prj_DevOpsKickoff/project003
python -m venv .venv
