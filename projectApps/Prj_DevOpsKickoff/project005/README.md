# project005 App (Prj_DevOpsKickoff)

- Track: `프로젝트-1`
- Topic: `DevOps 프로젝트 착수와 요구사항 정의 · 단계 5/5 운영 최적화`
- Curriculum Link: `project/Prj_DevOpsKickoff/project005/project005.md`
...
## Local Run
```bash
cd projectApps/Prj_DevOpsKickoff/project005
python -m venv .venv
