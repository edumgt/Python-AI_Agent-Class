# project008 App (Prj_MLOpsPipeline)

- Track: `프로젝트-2`
- Topic: `MLOps 파이프라인과 모델 레지스트리 · 단계 3/5 응용 확장`
- Curriculum Link: `project/Prj_MLOpsPipeline/project008/project008.md`
...
## Local Run
```bash
cd projectApps/Prj_MLOpsPipeline/project008
python -m venv .venv
