# project013 App (Prj_LLMOpsRAGQuality)

- Track: `프로젝트-3`
- Topic: `LLMOps/RAG 서비스 품질관리 · 단계 3/5 응용 확장`
- Curriculum Link: `project/Prj_LLMOpsRAGQuality/project013/project013.md`
...
## Local Run
```bash
cd projectApps/Prj_LLMOpsRAGQuality/project013
python -m venv .venv
