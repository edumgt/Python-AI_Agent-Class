...
"""
class520 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: AIOps 관측성·이상탐지·자동복구 · 단계 5/5 운영 최적화 [class520]
교육일차: Day 65
...
CLASS_ID = "CLASS520"
SUBJECT = "프로젝트"
MODULE = "AIOps 관측성·이상탐지·자동복구 · 단계 5/5 운영 최적화 [class520]"
DAY = "Day 65"
SLOT = "8교시"
SESSION = "20/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("class520_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
