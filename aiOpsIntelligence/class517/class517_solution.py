...
"""
class517 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: AIOps 관측성·이상탐지·자동복구 · 단계 2/5 기초 구현 [class517]
교육일차: Day 65
...
CLASS_ID = "CLASS517"
SUBJECT = "프로젝트"
MODULE = "AIOps 관측성·이상탐지·자동복구 · 단계 2/5 기초 구현 [class517]"
DAY = "Day 65"
SLOT = "5교시"
SESSION = "17/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("class517_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
