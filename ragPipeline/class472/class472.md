...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class471 / 벡터DB 기초** (Day 59 / 7교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class473 / 벡터DB 기초** (Day 60 / 1교시)
- 미리보기: 다음 차시 전에 **벡터DB 기초** 핵심 코드 1개를 다시 실행해 두면 벡터DB 기초 학습이 더 쉬워집니다.
