...
#### 학습주제 표현 분석: `프롬프트 결합`
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `프롬프트 결합` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class480 / 검색 품질 개선** (Day 60 / 8교시)
- 복습 연결: 이전에 배운 **검색 품질 개선** 를 떠올리며, 오늘 **프롬프트 결합** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class482 / 프롬프트 결합** (Day 61 / 2교시)
- 미리보기: 다음 차시 전에 **프롬프트 결합** 핵심 코드 1개를 다시 실행해 두면 프롬프트 결합 학습이 더 쉬워집니다.
