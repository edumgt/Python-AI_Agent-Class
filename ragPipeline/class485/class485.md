...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `프롬프트 결합 · 단계 5/5 운영 최적화 [class485]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class485` | 영문 기술명/약어 | class485 (한자 없음) | class485 | 용어 `class485`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |
