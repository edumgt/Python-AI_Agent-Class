...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `프롬프트 결합 · 단계 4/5 실전 검증 [class484]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class484` | 영문 기술명/약어 | class484 (한자 없음) | class484 | 용어 `class484`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class483 / 프롬프트 결합 · 단계 3/5 응용 확장 [class483]** (Day 61 / 3교시)
- 복습 연결: 이전에 배운 **프롬프트 결합 · 단계 3/5 응용 확장 [class483]** 를 떠올리며, 오늘 **프롬프트 결합 · 단계 4/5 실전 검증 [class484]** 와 어떤 점이 이어지는지 비교해 보세요.
...
N8["다음 준비: 프롬프트 결합 · 단계 5/5 운영 최적화 [class485] 연결 포인트 정리"]
N1 --> N2
N2 --> N3
N3 --> N4
N4 --> N5
