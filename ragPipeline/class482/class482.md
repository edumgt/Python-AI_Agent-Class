...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `프롬프트 결합 · 단계 2/5 기초 구현 [class482]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class482` | 영문 기술명/약어 | class482 (한자 없음) | class482 | 용어 `class482`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class481 / 프롬프트 결합 · 단계 1/5 입문 이해 [class481]** (Day 61 / 1교시)
- 복습 연결: 이전에 배운 **프롬프트 결합 · 단계 1/5 입문 이해 [class481]** 를 떠올리며, 오늘 **프롬프트 결합 · 단계 2/5 기초 구현 [class482]** 와 어떤 점이 이어지는지 비교해 보세요.
