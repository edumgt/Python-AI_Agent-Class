...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class489 / 응답 검증/출처화** (Day 62 / 1교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class491 / 평가 지표 설계** (Day 62 / 3교시)
- 미리보기: 다음 차시 전에 **응답 검증/출처화** 핵심 코드 1개를 다시 실행해 두면 평가 지표 설계 학습이 더 쉬워집니다.
