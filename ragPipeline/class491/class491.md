...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class490 / 응답 검증/출처화** (Day 62 / 2교시)
- 복습 연결: 이전에 배운 **응답 검증/출처화** 를 떠올리며, 오늘 **평가 지표 설계** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class492 / 평가 지표 설계** (Day 62 / 4교시)
- 미리보기: 다음 차시 전에 **평가 지표 설계** 핵심 코드 1개를 다시 실행해 두면 평가 지표 설계 학습이 더 쉬워집니다.
