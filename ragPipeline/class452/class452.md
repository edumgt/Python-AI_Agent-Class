...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `RAG 개요 · 단계 4/6 응용 확장 [class452]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
| `RAG` | 약어명사 | RAG (한자 없음) | Retrieval-Augmented Generation | 검색 결과를 근거로 생성 품질과 신뢰도를 높이는 구조입니다. |
...
| `class452` | 영문 기술명/약어 | class452 (한자 없음) | class452 | 용어 `class452`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class451 / RAG 개요 · 단계 3/6 응용 확장 [class451]** (Day 57 / 3교시)
- 복습 연결: 이전에 배운 **RAG 개요 · 단계 3/6 응용 확장 [class451]** 를 떠올리며, 오늘 **RAG 개요 · 단계 4/6 응용 확장 [class452]** 와 어떤 점이 이어지는지 비교해 보세요.
