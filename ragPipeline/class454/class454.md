...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class453 / RAG 개요** (Day 57 / 5교시)
- 복습 연결: 이전에 배운 **RAG 개요** 를 떠올리며, 오늘 **RAG 개요** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class455 / 문서 수집 전략** (Day 57 / 7교시)
- 미리보기: 다음 차시 전에 **RAG 개요** 핵심 코드 1개를 다시 실행해 두면 문서 수집 전략 학습이 더 쉬워집니다.
