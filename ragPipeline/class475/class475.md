...
- 복습 연결: 이전에 배운 **벡터DB 기초 · 단계 5/5 운영 최적화 [class474]** 를 떠올리며, 오늘 **검색 품질 개선 · 단계 1/6 입문 이해 [class475]** 와 어떤 점이 이어지는지 비교해 보세요.
...
N8["다음 준비: 검색 품질 개선 · 단계 2/6 기초 구현 [class476] 연결 포인트 정리"]
N1 --> N2
N2 --> N3
N3 --> N4
N4 --> N5
