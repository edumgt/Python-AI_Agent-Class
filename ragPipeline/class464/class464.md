...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class463 / 문서 청크 설계** (Day 58 / 7교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class465 / 임베딩 생성** (Day 59 / 1교시)
- 미리보기: 다음 차시 전에 **문서 청크 설계** 핵심 코드 1개를 다시 실행해 두면 임베딩 생성 학습이 더 쉬워집니다.
