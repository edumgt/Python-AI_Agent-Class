...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class249 / STT 전처리/학습** (Day 32 / 1교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class251 / TTS 파이프라인** (Day 32 / 3교시)
- 미리보기: 다음 차시 전에 **STT 전처리/학습** 핵심 코드 1개를 다시 실행해 두면 TTS 파이프라인 학습이 더 쉬워집니다.
