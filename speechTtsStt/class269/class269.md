...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class268 / TTS 전처리/학습** (Day 34 / 4교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class270 / 음성 품질 평가** (Day 34 / 6교시)
- 미리보기: 다음 차시 전에 **TTS 전처리/학습** 핵심 코드 1개를 다시 실행해 두면 음성 품질 평가 학습이 더 쉬워집니다.
