...
- 기술 포인트: 이번 차시는 `STT 파이프라인 · 단계 5/6 실전 검증 [class236]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
| `STT` | 약어명사 | STT (한자 없음) | Speech-to-Text | 음성 신호를 텍스트로 변환하는 기술입니다. |
...
| `class236` | 영문 기술명/약어 | class236 (한자 없음) | class236 | 용어 `class236`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class235 / STT 파이프라인 · 단계 4/6 응용 확장 [class235]** (Day 30 / 3교시)
- 복습 연결: 이전에 배운 **STT 파이프라인 · 단계 4/6 응용 확장 [class235]** 를 떠올리며, 오늘 **STT 파이프라인 · 단계 5/6 실전 검증 [class236]** 와 어떤 점이 이어지는지 비교해 보세요.
