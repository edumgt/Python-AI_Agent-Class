...
- 기술 포인트: 이번 차시는 `TTS 파이프라인 · 단계 4/6 응용 확장 [class254]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
| `TTS` | 약어명사 | TTS (한자 없음) | Text-to-Speech | 텍스트를 자연스러운 음성으로 합성하는 기술입니다. |
...
| `class254` | 영문 기술명/약어 | class254 (한자 없음) | class254 | 용어 `class254`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |
