...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class228 / 음성 AI 개요** (Day 29 / 4교시)
...
## 5) 오늘의 예제 코드
- 예제 파일: `class229_example.py`
- 실행 명령:
```bash
python speechTtsStt/class229/class229_example.py
```
...
python3 speechTtsStt/class229/class229_example.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python speechTtsStt/class229/class229_example.py`)
...
N7["예제 실행: python speechTtsStt/class229/class229_example.py"]
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class230 / 음성 AI 개요** (Day 29 / 6교시)
