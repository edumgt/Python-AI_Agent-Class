...
- 기술 포인트: 이번 차시는 `평가와 개선` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class379 / 평가와 개선** (Day 48 / 3교시)
- 복습 연결: 이전에 배운 **평가와 개선** 를 떠올리며, 오늘 **평가와 개선** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class381 / 자동화 프롬프트 패턴** (Day 48 / 5교시)
- 미리보기: 다음 차시 전에 **평가와 개선** 핵심 코드 1개를 다시 실행해 두면 자동화 프롬프트 패턴 학습이 더 쉬워집니다.
