...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class375 / 단계적 추론 유도** (Day 47 / 7교시)
- 복습 연결: 이전에 배운 **단계적 추론 유도** 를 떠올리며, 오늘 **단계적 추론 유도** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class377 / 평가와 개선** (Day 48 / 1교시)
- 미리보기: 다음 차시 전에 **단계적 추론 유도** 핵심 코드 1개를 다시 실행해 두면 평가와 개선 학습이 더 쉬워집니다.
