...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class387 / 도메인 템플릿 작성** (Day 49 / 3교시)
...
## 5) 오늘의 예제 코드
- 예제 파일: `class388_example.py`
- 실행 명령:
```bash
python promptEng/class388/class388_example.py
```
...
python3 promptEng/class388/class388_example.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python promptEng/class388/class388_example.py`)
...
N7["예제 실행: python promptEng/class388/class388_example.py"]
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class389 / 실전 프롬프트 튜닝** (Day 49 / 5교시)
- 미리보기: 다음 차시 전에 **도메인 템플릿 작성** 핵심 코드 1개를 다시 실행해 두면 실전 프롬프트 튜닝 학습이 더 쉬워집니다.
