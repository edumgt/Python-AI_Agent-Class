...
## 1) 오늘의 학습 정보
- 교과목: **프롬프트 엔지니어링**
- 학습 주제: **단계적 추론 유도 · 단계 1/4 입문 이해 [class373]**
- 학습 주제 진행: **단계적 추론 유도 · 단계 1/4 입문 이해 [class373] (총 4시간 중 1시간차)**
- 세부 시퀀스: **21/40**
- 일정: **Day 47 / 5교시**
...
#### 학습주제 표현 분석: `단계적 추론 유도 · 단계 1/4 입문 이해 [class373]`
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `단계적 추론 유도 · 단계 1/4 입문 이해 [class373]`를 중심으로 같은 주제 내에서 단계적으로 고도화된 구현을 수행합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class372 / 예시 기반 학습 · 단계 4/4 운영 최적화 [class372]** (Day 47 / 4교시)
- 복습 연결: 이전에 배운 **예시 기반 학습 · 단계 4/4 운영 최적화 [class372]** 를 떠올리며, 오늘 **단계적 추론 유도 · 기능 통합 요구사항 정제 (차시 21) [class373]** 와 어떤 점이 이어지는지 비교해 보세요.

## 3) 주제를 아주 쉽게 이해하기
- 한 줄 설명: 단계적 추론 유도를 단계 1/4(입문 이해) 수준으로 고도화해 구현하는 차시입니다.
- 왜 배우나요?: 동일 주제를 반복하더라도 단계별 난이도를 높여 실무 수준의 문제 해결력을 만들기 위해서입니다.

### 핵심 개념 3가지
1. `단계적 추론 유도`의 핵심 입력/출력 구조를 단계 1/4 기준으로 명확히 정의합니다.
...
## 5) 오늘의 예제 코드
- 예제 파일: `class373_example1.py`
- 실행 명령:
```bash
python promptEng/class373/class373_example1.py
```
...
python3 promptEng/class373/class373_example1.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python promptEng/class373/class373_example1.py`)
- 주요 문법: `문자열 템플릿`, `함수`, `변수 치환`, `출력(print)`
- 학습 포커스: `단계적 추론 유도 · 단계 1/4 입문 이해 [class373]`

### 실습 example1.py 동작 원리 (Mermaid Flowchart)
```mermaid
flowchart TD
N1["시작: class373 (21/40, 기초응용)"]
N2["학습 주제 파악: 단계적 추론 유도 · 단계 1/4 입문 이해 [class373]"]
N3["1단계: 역할/목표/형식을 명확히 정의한다"]
N4["2단계: 프롬프트 템플릿을 작성한다"]
N5["3단계: 예시를 바꿔 응답 품질을 비교한다"]
N6["4단계: 평가 기준에 맞게 프롬프트를 튜닝한다"]
N7["예제 실행: python promptEng/class373/class373_example1.py"]
N8["다음 준비: 단계적 추론 유도 · 단계 1/4 입문 이해 [class373] 연결 포인트 정리"]
N1 --> N2
N2 --> N3
N3 --> N4
N4 --> N5
...
### 실습 미션
1. `단계적 추론 유도` 단계 1/4 목표 기능을 코드로 구현하고 실행 로그를 남기세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class374 / 단계적 추론 유도 · 단계 2/4 기초 구현 [class374]** (Day 47 / 6교시)
- 미리보기: 다음 차시 전에 **단계적 추론 유도 · 단계 1/4 입문 이해 [class373]** 핵심 코드 1개를 다시 실행해 두면 단계적 추론 유도 · 단계 2/4 기초 구현 [class374] 학습이 더 쉬워집니다.
