...
"""
class501 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: DevOps 프로젝트 착수와 요구사항 정의 · 단계 1/5 입문 이해 [class501]
교육일차: Day 63
...
CLASS_ID = "CLASS501"
SUBJECT = "프로젝트"
MODULE = "DevOps 프로젝트 착수와 요구사항 정의 · 단계 1/5 입문 이해 [class501]"
DAY = "Day 63"
SLOT = "5교시"
SESSION = "1/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("class501_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
