...
"""
class506 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: MLOps 파이프라인과 모델 레지스트리 · 단계 1/5 입문 이해 [class506]
교육일차: Day 64
...
CLASS_ID = "CLASS506"
SUBJECT = "프로젝트"
MODULE = "MLOps 파이프라인과 모델 레지스트리 · 단계 1/5 입문 이해 [class506]"
DAY = "Day 64"
SLOT = "2교시"
SESSION = "6/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("class506_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
