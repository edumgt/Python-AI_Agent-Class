...
"""
class510 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: MLOps 파이프라인과 모델 레지스트리 · 단계 5/5 운영 최적화 [class510]
교육일차: Day 64
...
CLASS_ID = "CLASS510"
SUBJECT = "프로젝트"
MODULE = "MLOps 파이프라인과 모델 레지스트리 · 단계 5/5 운영 최적화 [class510]"
DAY = "Day 64"
SLOT = "6교시"
SESSION = "10/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("class510_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
