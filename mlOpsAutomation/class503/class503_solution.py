...
"""
class503 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: DevOps 프로젝트 착수와 요구사항 정의 · 단계 3/5 응용 확장 [class503]
교육일차: Day 63
...
CLASS_ID = "CLASS503"
SUBJECT = "프로젝트"
MODULE = "DevOps 프로젝트 착수와 요구사항 정의 · 단계 3/5 응용 확장 [class503]"
DAY = "Day 63"
SLOT = "7교시"
SESSION = "3/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("class503_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
