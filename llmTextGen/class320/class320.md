...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class319 / 요약/분류/추출** (Day 40 / 7교시)
- 복습 연결: 이전에 배운 **요약/분류/추출** 를 떠올리며, 오늘 **요약/분류/추출** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class321 / 대화형 응답 설계** (Day 41 / 1교시)
- 미리보기: 다음 차시 전에 **요약/분류/추출** 핵심 코드 1개를 다시 실행해 두면 대화형 응답 설계 학습이 더 쉬워집니다.
