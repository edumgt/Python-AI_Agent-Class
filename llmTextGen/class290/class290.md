...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class289 / LLM 개요** (Day 37 / 1교시)
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python llmTextGen/class290/class290_example.py`)
...
N7["예제 실행: python llmTextGen/class290/class290_example.py"]
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class291 / LLM 개요** (Day 37 / 3교시)
