...
#### 학습주제 표현 분석: `토큰/컨텍스트 이해`
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `토큰/컨텍스트 이해` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class298 / 토큰/컨텍스트 이해** (Day 38 / 2교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class300 / 토큰/컨텍스트 이해** (Day 38 / 4교시)
