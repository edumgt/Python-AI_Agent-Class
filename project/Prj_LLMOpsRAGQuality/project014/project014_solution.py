...
"""
project014 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: LLMOps/RAG 서비스 품질관리 · 단계 4/5 실전 검증 [project014]
교육일차: Day 65
일일 교시: 2교시 (1일 8시간 운영 기준)
난이도: 실전심화
실행 방법:
    python project014.py
"""
...
CLASS_ID = "CLASS514"
SUBJECT = "프로젝트"
MODULE = "LLMOps/RAG 서비스 품질관리 · 단계 4/5 실전 검증 [project014]"
DAY = "Day 65"
SLOT = "2교시"
SESSION = "14/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("project014_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
