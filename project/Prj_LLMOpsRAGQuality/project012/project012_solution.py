...
"""
project012 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: LLMOps/RAG 서비스 품질관리 · 단계 2/5 기초 구현 [project012]
교육일차: Day 64
...
CLASS_ID = "CLASS512"
SUBJECT = "프로젝트"
MODULE = "LLMOps/RAG 서비스 품질관리 · 단계 2/5 기초 구현 [project012]"
DAY = "Day 64"
SLOT = "8교시"
SESSION = "12/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("project012_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
