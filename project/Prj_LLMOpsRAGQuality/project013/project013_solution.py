...
"""
project013 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: LLMOps/RAG 서비스 품질관리 · 단계 3/5 응용 확장 [project013]
교육일차: Day 65
일일 교시: 1교시 (1일 8시간 운영 기준)
난이도: 기초응용
실행 방법:
    python project013.py
"""
...
CLASS_ID = "CLASS513"
SUBJECT = "프로젝트"
MODULE = "LLMOps/RAG 서비스 품질관리 · 단계 3/5 응용 확장 [project013]"
DAY = "Day 65"
SLOT = "1교시"
SESSION = "13/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("project013_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
