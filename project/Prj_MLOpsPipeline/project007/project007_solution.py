...
"""
project007 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: MLOps 파이프라인과 모델 레지스트리 · 단계 2/5 기초 구현 [project007]
교육일차: Day 64
일일 교시: 3교시 (1일 8시간 운영 기준)
난이도: 기초응용
실행 방법:
    python project007.py
"""
...
CLASS_ID = "CLASS507"
SUBJECT = "프로젝트"
MODULE = "MLOps 파이프라인과 모델 레지스트리 · 단계 2/5 기초 구현 [project007]"
DAY = "Day 64"
SLOT = "3교시"
SESSION = "7/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("project007_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
