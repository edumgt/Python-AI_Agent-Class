...
"""
project009 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: MLOps 파이프라인과 모델 레지스트리 · 단계 4/5 실전 검증 [project009]
교육일차: Day 64
일일 교시: 5교시 (1일 8시간 운영 기준)
난이도: 실전심화
실행 방법:
    python project009.py
"""
...
CLASS_ID = "CLASS509"
SUBJECT = "프로젝트"
MODULE = "MLOps 파이프라인과 모델 레지스트리 · 단계 4/5 실전 검증 [project009]"
DAY = "Day 64"
SLOT = "5교시"
SESSION = "9/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("project009_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
