...
"""
project008 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: MLOps 파이프라인과 모델 레지스트리 · 단계 3/5 응용 확장 [project008]
교육일차: Day 64
일일 교시: 4교시 (1일 8시간 운영 기준)
난이도: 실전심화
실행 방법:
    python project008.py
"""
...
CLASS_ID = "CLASS508"
SUBJECT = "프로젝트"
MODULE = "MLOps 파이프라인과 모델 레지스트리 · 단계 3/5 응용 확장 [project008]"
DAY = "Day 64"
SLOT = "4교시"
SESSION = "8/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("project008_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
