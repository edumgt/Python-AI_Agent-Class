# project009 App (Prj_PersonaVoiceAI)

- Track: `프로젝트-2`
- Topic: `PERSONA 코칭 대화 파이프라인(STT↔LLM↔TTS) · 단계 4/5 실전 검증`
- Curriculum Link: `project/Prj_PersonaVoiceAI/project009/project009.md`
...
## Local Run
```bash
cd project/Prj_PersonaVoiceAI/project009
python -m venv .venv
