# project014 App (Prj_PersonaVoiceAI)

- Track: `프로젝트-3`
- Topic: `사전 데이터 기반 PERSONA AI 구축 · 단계 4/5 실전 검증`
- Curriculum Link: `project/Prj_PersonaVoiceAI/project014/project014.md`
...
## Local Run
```bash
cd project/Prj_PersonaVoiceAI/project014
python -m venv .venv
