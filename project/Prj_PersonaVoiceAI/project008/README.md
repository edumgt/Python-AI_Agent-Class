# project008 App (Prj_PersonaVoiceAI)

- Track: `프로젝트-2`
- Topic: `PERSONA 코칭 대화 파이프라인(STT↔LLM↔TTS) · 단계 3/5 응용 확장`
- Curriculum Link: `project/Prj_PersonaVoiceAI/project008/project008.md`
...
## Local Run
```bash
cd project/Prj_PersonaVoiceAI/project008
python -m venv .venv
