# project004 App (Prj_PersonaVoiceAI)

- Track: `프로젝트-1`
- Topic: `개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 4/5 실전 검증`
- Curriculum Link: `project/Prj_PersonaVoiceAI/project004/project004.md`
...
## Local Run
```bash
cd project/Prj_PersonaVoiceAI/project004
python -m venv .venv
