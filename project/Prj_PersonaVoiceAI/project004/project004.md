...
## 1) 오늘의 학습 정보
- 교과목: **프로젝트**
- 학습 주제: **개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 4/5 실전 검증 [project004]**
- 세부 시퀀스: **4/20**
- 일정: **Day 63 / 8교시**
- 난이도: **실전심화**
...
#### 학습주제 표현 분석: `개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 4/5 실전 검증 [project004]`
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **project003 / 개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 3/5 응용 확장 [project003]** (Day 63 / 7교시)
- 복습 연결: 이전에 배운 **개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 3/5 응용 확장 [project003]** 를 떠올리며, 오늘 **개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 4/5 실전 검증 [project004]** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 5) 오늘의 예제 코드
- 예제 파일: `project004_example1.py`
- 실행 명령:
```bash
python project/Prj_PersonaVoiceAI/project004/project004_example1.py
```
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python project/Prj_PersonaVoiceAI/project004/project004_example1.py`)
- 주요 문법: `프로필 dict`, `규칙 기반 라우팅`, `코칭 시나리오 함수`, `실행 로그 출력`
- 학습 포커스: `개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 4/5 실전 검증 [project004]`

### 실습 example1.py 동작 원리 (Mermaid Flowchart)
```mermaid
flowchart TD
N1["시작: project004 (4/20, 실전심화)"]
N2["학습 주제 파악: 개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 4/5 실전 검증 [project004]"]
N3["1단계: PERSONA 목표와 코칭 범위를 정의한다"]
N4["2단계: 프로필 규칙과 대화 시나리오를 구조화한다"]
N5["3단계: 텍스트 응답과 음성 출력 흐름을 연결한다"]
N6["4단계: 기초 동작 결과를 체크리스트로 검증한다"]
N7["예제 실행: python project/Prj_PersonaVoiceAI/project004/project004_example1.py"]
N8["다음 준비: 개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 5/5 운영 최적화 [project005] 연결 포인트 정리"]
N1 --> N2
N2 --> N3
N3 --> N4
N4 --> N5
...
### Flow PNG 캡처
![project004 flow](project004_flow.png)
...
## 6) 퀴즈로 복습하기 (10문항)
- 퀴즈 파일: `project004_quiz.html`
- 브라우저에서 열기:
```bash
project/Prj_PersonaVoiceAI/project004/project004_quiz.html
```
- 버튼 설명:
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **project005 / 개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 5/5 운영 최적화 [project005]** (Day 64 / 1교시)
- 미리보기: 다음 차시 전에 **개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 4/5 실전 검증 [project004]** 핵심 코드 1개를 다시 실행해 두면 개인 맞춤 코칭 음성봇 PERSONA AI 만들기 · 단계 5/5 운영 최적화 [project005] 학습이 더 쉬워집니다.
