...
"""
project002 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: DevOps 프로젝트 착수와 요구사항 정의 · 단계 2/5 기초 구현 [project002]
교육일차: Day 63
일일 교시: 6교시 (1일 8시간 운영 기준)
난이도: 기초응용
실행 방법:
    python project002.py
"""
...
CLASS_ID = "CLASS502"
SUBJECT = "프로젝트"
MODULE = "DevOps 프로젝트 착수와 요구사항 정의 · 단계 2/5 기초 구현 [project002]"
DAY = "Day 63"
SLOT = "6교시"
SESSION = "2/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("project002_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
