...
"""
project005 advanced practice script
교과구분: 프로젝트-1
교과목명: 프로젝트
차시 주제: DevOps 프로젝트 착수와 요구사항 정의 · 단계 5/5 운영 최적화 [project005]
교육일차: Day 64
일일 교시: 1교시 (1일 8시간 운영 기준)
난이도: 실전심화
실행 방법:
    python project005.py
"""
...
CLASS_ID = "CLASS505"
SUBJECT = "프로젝트"
MODULE = "DevOps 프로젝트 착수와 요구사항 정의 · 단계 5/5 운영 최적화 [project005]"
DAY = "Day 64"
SLOT = "1교시"
SESSION = "5/20"
...
def run_practice() -> None:
    ...
    text = "\n".join(lines)
    print(text)
    out_file = save_output("project005_result.txt", text)
    print(f"\n산출물 저장: {out_file}")
