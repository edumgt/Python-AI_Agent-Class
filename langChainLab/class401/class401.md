...
# class401 자기주도 학습 가이드

## 1) 오늘의 학습 정보
- 교과목: **Langchain 활용하기**
- 학습 주제: **PromptTemplate · 단계 3/6 응용 확장 [class401]**
- 세부 시퀀스: **9/56**
- 일정: **Day 51 / 1교시**
- 난이도: **입문**
...
#### 학습주제 표현 분석: `PromptTemplate · 단계 3/6 응용 확장 [class401]`
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class400 / PromptTemplate · 단계 2/6 기초 구현 [class400]** (Day 50 / 8교시)
- 복습 연결: 이전에 배운 **PromptTemplate · 단계 2/6 기초 구현 [class400]** 를 떠올리며, 오늘 **PromptTemplate · 단계 3/6 응용 확장 [class401]** 와 어떤 점이 이어지는지 비교해 보세요.
...
N2["학습 주제 파악: PromptTemplate · 단계 3/6 응용 확장 [class401]"]
...
N8["다음 준비: PromptTemplate · 단계 4/6 응용 확장 [class402] 연결 포인트 정리"]
N1 --> N2
N2 --> N3
N3 --> N4
N4 --> N5
...
### Flow PNG 캡처
![class401 flow](class401_flow.png)
...
## 6) 퀴즈로 복습하기 (10문항)
- 퀴즈 파일: `class401_quiz.html`
- 브라우저에서 열기:
```bash
langChainLab/class401/class401_quiz.html
```
- 버튼 설명:
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class402 / PromptTemplate · 단계 4/6 응용 확장 [class402]** (Day 51 / 2교시)
- 미리보기: 다음 차시 전에 **PromptTemplate · 단계 3/6 응용 확장 [class401]** 핵심 코드 1개를 다시 실행해 두면 PromptTemplate · 단계 4/6 응용 확장 [class402] 학습이 더 쉬워집니다.
