...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class408 / Model/LLM 연결** (Day 51 / 8교시)
...
## 5) 오늘의 예제 코드
- 예제 파일: `class409_example.py`
- 실행 명령:
```bash
python langChainLab/class409/class409_example.py
```
...
python3 langChainLab/class409/class409_example.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python langChainLab/class409/class409_example.py`)
...
N7["예제 실행: python langChainLab/class409/class409_example.py"]
...
### Flow PNG 캡처
![class409 flow](class409_flow.png)
...
- 브라우저에서 열기:
```bash
langChainLab/class409/class409_quiz.html
```
- 버튼 설명:
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class410 / OutputParser** (Day 52 / 2교시)
- 미리보기: 다음 차시 전에 **Model/LLM 연결** 핵심 코드 1개를 다시 실행해 두면 OutputParser 학습이 더 쉬워집니다.
