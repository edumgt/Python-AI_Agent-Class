...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class430 / Tool/Agent 기초** (Day 54 / 6교시)
...
## 5) 오늘의 예제 코드
- 예제 파일: `class431_example.py`
- 실행 명령:
```bash
python langChainLab/class431/class431_example.py
```
...
python3 langChainLab/class431/class431_example.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python langChainLab/class431/class431_example.py`)
...
N7["예제 실행: python langChainLab/class431/class431_example.py"]
...
### Flow PNG 캡처
![class431 flow](class431_flow.png)
...
- 브라우저에서 열기:
```bash
langChainLab/class431/class431_quiz.html
```
- 버튼 설명:
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class432 / Tool/Agent 기초** (Day 54 / 8교시)
