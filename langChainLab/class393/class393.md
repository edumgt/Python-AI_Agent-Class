...
- 기술 포인트: 이번 차시는 `LangChain 개요 · 단계 1/6 입문 이해 [class393]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
| `LangChain` | 고유명사(프레임워크명) | LangChain (한자 없음) | LangChain | LLM 애플리케이션을 체인/도구 기반으로 구성하는 프레임워크입니다. |
...
| `class393` | 영문 기술명/약어 | class393 (한자 없음) | class393 | 용어 `class393`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |
