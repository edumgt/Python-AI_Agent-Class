...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class040 / 미니 실습 프로젝트** (Day 05 / 8교시)
- 복습 연결: 이전에 배운 **미니 실습 프로젝트** 를 떠올리며, 오늘 **데이터 분석 환경 구성** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 5) 오늘의 예제 코드
- 예제 파일: `class041_example.py`
- 실행 명령:
```bash
python dataVizPrep/class041/class041_example.py
```
...
python3 dataVizPrep/class041/class041_example.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python dataVizPrep/class041/class041_example.py`)
...
N7["예제 실행: python dataVizPrep/class041/class041_example.py"]
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class042 / 데이터 분석 환경 구성** (Day 06 / 2교시)
