...
- 기술 포인트: 이번 차시는 `그룹화와 집계 · 단계 3/4 실전 검증 [class063]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class063` | 영문 기술명/약어 | class063 (한자 없음) | class063 | 용어 `class063`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |
