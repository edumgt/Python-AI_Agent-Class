...
"""class069 example4: Matplotlib 시각화 기초 · 단계 1/4 입문 이해 [class069]"""

TOPIC = "Matplotlib 시각화 기초 · 단계 1/4 입문 이해 [class069]"
...
def save_chart(points, case_name):
    ...
    out = Path(__file__).with_name(f"class069_plot_{token}.png")
    try:
