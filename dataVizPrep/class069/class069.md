...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class068 / 데이터 병합과 변환** (Day 09 / 4교시)
- 복습 연결: 이전에 배운 **데이터 병합과 변환** 를 떠올리며, 오늘 **Matplotlib 시각화 기초** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class070 / Matplotlib 시각화 기초** (Day 09 / 6교시)
