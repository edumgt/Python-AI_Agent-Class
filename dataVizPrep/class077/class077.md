...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class076 / Seaborn/실전 차트 해석** (Day 10 / 4교시)
- 복습 연결: 이전에 배운 **Seaborn/실전 차트 해석** 를 떠올리며, 오늘 **전처리+시각화 미니 프로젝트** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class078 / 전처리+시각화 미니 프로젝트** (Day 10 / 6교시)
