...
- 기술 포인트: 이번 차시는 `Matplotlib 시각화 기초 · 단계 2/4 기초 구현 [class070]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class070` | 영문 기술명/약어 | class070 (한자 없음) | class070 | 용어 `class070`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class069 / Matplotlib 시각화 기초 · 단계 1/4 입문 이해 [class069]** (Day 09 / 5교시)
- 복습 연결: 이전에 배운 **Matplotlib 시각화 기초 · 단계 1/4 입문 이해 [class069]** 를 떠올리며, 오늘 **Matplotlib 시각화 기초 · 단계 2/4 기초 구현 [class070]** 와 어떤 점이 이어지는지 비교해 보세요.
