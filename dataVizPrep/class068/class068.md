...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class067 / 데이터 병합과 변환** (Day 09 / 3교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class069 / Matplotlib 시각화 기초** (Day 09 / 5교시)
- 미리보기: 다음 차시 전에 **데이터 병합과 변환** 핵심 코드 1개를 다시 실행해 두면 Matplotlib 시각화 기초 학습이 더 쉬워집니다.
