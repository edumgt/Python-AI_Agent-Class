...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class052 / Pandas 데이터프레임 기초** (Day 07 / 4교시)
- 복습 연결: 이전에 배운 **Pandas 데이터프레임 기초** 를 떠올리며, 오늘 **결측치/이상치 처리** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class054 / 결측치/이상치 처리** (Day 07 / 6교시)
