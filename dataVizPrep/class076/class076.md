...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class075 / Seaborn/실전 차트 해석** (Day 10 / 3교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class077 / 전처리+시각화 미니 프로젝트** (Day 10 / 5교시)
- 미리보기: 다음 차시 전에 **Seaborn/실전 차트 해석** 핵심 코드 1개를 다시 실행해 두면 전처리+시각화 미니 프로젝트 학습이 더 쉬워집니다.
