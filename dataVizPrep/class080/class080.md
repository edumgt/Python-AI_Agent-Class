...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class079 / 전처리+시각화 미니 프로젝트** (Day 10 / 7교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class081 / ML/DL 개요와 문제정의** (Day 11 / 1교시)
- 미리보기: 다음 차시 전에 **전처리+시각화 미니 프로젝트** 핵심 코드 1개를 다시 실행해 두면 ML/DL 개요와 문제정의 학습이 더 쉬워집니다.
