...
"""class075 example3: Seaborn/실전 차트 해석 · 단계 3/4 실전 검증 [class075]"""

TOPIC = "Seaborn/실전 차트 해석 · 단계 3/4 실전 검증 [class075]"
...
def save_chart(points, case_name):
    ...
    out = Path(__file__).with_name(f"class075_plot_{token}.png")
    try:
