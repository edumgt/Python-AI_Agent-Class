...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class071 / Matplotlib 시각화 기초** (Day 09 / 7교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class073 / Seaborn/실전 차트 해석** (Day 10 / 1교시)
- 미리보기: 다음 차시 전에 **Matplotlib 시각화 기초** 핵심 코드 1개를 다시 실행해 두면 Seaborn/실전 차트 해석 학습이 더 쉬워집니다.
