...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class051 / Pandas 데이터프레임 기초** (Day 07 / 3교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class053 / 결측치/이상치 처리** (Day 07 / 5교시)
- 미리보기: 다음 차시 전에 **Pandas 데이터프레임 기초** 핵심 코드 1개를 다시 실행해 두면 결측치/이상치 처리 학습이 더 쉬워집니다.
