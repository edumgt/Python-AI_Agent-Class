...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class102 / 모델 평가 지표** (Day 13 / 6교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class104 / 모델 평가 지표** (Day 13 / 8교시)
- 미리보기: 다음 차시 전에 **모델 평가 지표** 핵심 코드 1개를 다시 실행해 두면 모델 평가 지표 학습이 더 쉬워집니다.
