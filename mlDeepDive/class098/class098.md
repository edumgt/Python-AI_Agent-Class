...
- 기술 포인트: 이번 차시는 `분류 모델 · 단계 3/5 응용 확장 [class098]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class098` | 영문 기술명/약어 | class098 (한자 없음) | class098 | 용어 `class098`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class097 / 분류 모델 · 단계 2/5 기초 구현 [class097]** (Day 13 / 1교시)
- 복습 연결: 이전에 배운 **분류 모델 · 단계 2/5 기초 구현 [class097]** 를 떠올리며, 오늘 **분류 모델 · 단계 3/5 응용 확장 [class098]** 와 어떤 점이 이어지는지 비교해 보세요.
