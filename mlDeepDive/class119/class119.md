...
- 기술 포인트: 이번 차시는 `신경망 기초` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class118 / 신경망 기초** (Day 15 / 6교시)
- 복습 연결: 이전에 배운 **신경망 기초** 를 떠올리며, 오늘 **신경망 기초** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class120 / 딥러닝 학습 구조** (Day 15 / 8교시)
- 미리보기: 다음 차시 전에 **신경망 기초** 핵심 코드 1개를 다시 실행해 두면 딥러닝 학습 구조 학습이 더 쉬워집니다.
