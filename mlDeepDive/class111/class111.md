...
- 문법 포인트: 명사와 명사를 대등하게 묶는 병렬 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `과적합과 일반화 · 단계 2/5 기초 구현 [class111]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class111` | 영문 기술명/약어 | class111 (한자 없음) | class111 | 용어 `class111`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |
