...
- 문법 포인트: 명사와 명사를 대등하게 묶는 병렬 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `특성공학과 전처리 · 단계 1/5 입문 이해 [class105]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class105` | 영문 기술명/약어 | class105 (한자 없음) | class105 | 용어 `class105`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class104 / 모델 평가 지표 · 단계 4/4 운영 최적화 [class104]** (Day 13 / 8교시)
- 복습 연결: 이전에 배운 **모델 평가 지표 · 단계 4/4 운영 최적화 [class104]** 를 떠올리며, 오늘 **특성공학과 전처리 · 단계 1/5 입문 이해 [class105]** 와 어떤 점이 이어지는지 비교해 보세요.
