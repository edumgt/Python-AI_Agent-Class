...
- 기술 포인트: 이번 차시는 `지도학습 기초` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class088 / 지도학습 기초** (Day 11 / 8교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class090 / 지도학습 기초** (Day 12 / 2교시)
- 미리보기: 다음 차시 전에 **지도학습 기초** 핵심 코드 1개를 다시 실행해 두면 지도학습 기초 학습이 더 쉬워집니다.
