...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class024 / 컬렉션 자료구조** (Day 03 / 8교시)
- 복습 연결: 이전에 배운 **컬렉션 자료구조** 를 떠올리며, 오늘 **파일 입출력** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class026 / 파일 입출력** (Day 04 / 2교시)
- 미리보기: 다음 차시 전에 **파일 입출력** 핵심 코드 1개를 다시 실행해 두면 파일 입출력 학습이 더 쉬워집니다.
