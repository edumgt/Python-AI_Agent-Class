...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class028 / 파일 입출력** (Day 04 / 4교시)
- 복습 연결: 이전에 배운 **파일 입출력** 를 떠올리며, 오늘 **예외처리와 디버깅** 와 어떤 점이 이어지는지 비교해 보세요.
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python pyBasics/class029/class029_example.py`)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class030 / 예외처리와 디버깅** (Day 04 / 6교시)
