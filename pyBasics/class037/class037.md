...
- 기술 포인트: 이번 차시는 `FastAPI와 Uvicorn · 단계 1/2 입문 이해 [class037]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class037` | 영문 기술명/약어 | class037 (한자 없음) | class037 | 용어 `class037`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class036 / API 기본 개념과 HTTP · 단계 2/2 운영 최적화 [class036]** (Day 05 / 4교시)
- 복습 연결: 이전에 배운 **API 기본 개념과 HTTP · 단계 2/2 운영 최적화 [class036]** 를 떠올리며, 오늘 **FastAPI와 Uvicorn · 단계 1/2 입문 이해 [class037]** 와 어떤 점이 이어지는지 비교해 보세요.
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python pyBasics/class037/class037_example1.py`)
