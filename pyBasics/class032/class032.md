...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class031 / 예외처리와 디버깅** (Day 04 / 7교시)
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python pyBasics/class032/class032_example.py`)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class033 / 객체지향 기초** (Day 05 / 1교시)
- 미리보기: 다음 차시 전에 **예외처리와 디버깅** 핵심 코드 1개를 다시 실행해 두면 객체지향 기초 학습이 더 쉬워집니다.
