...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `수업 준비 1: 필수 플랫폼 가입/계정 설정 (class001) · 단계 1/1 입문 이해 [class001]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `플랫폼` | 명사(기술 개념어) | 플랫폼 (한자 없음) | (context-specific) | 용어 `플랫폼`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
| `가입` | 명사(기술 개념어) | 가입 (한자 없음) | (context-specific) | 용어 `가입`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
| `계정` | 명사(기술 개념어) | 계정 (한자 없음) | (context-specific) | 용어 `계정`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
