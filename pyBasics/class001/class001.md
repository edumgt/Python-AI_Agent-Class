...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `수업 준비 1: 필수 플랫폼 가입/계정 설정 (class001)` 핵심 개념을 코드 구현, 결과 해석, 점검 기준으로 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
| `플랫폼` | 명사(주제 핵심 용어) | 플랫폼 (한자 없음) | (topic-specific) | `플랫폼`는 `수업 준비 1: 필수 플랫폼 가입/계정 설정 (class001)` 실습에서 코드 구조와 실행 결과를 안정적으로 만들기 위한 핵심 용어입니다. |
| `가입` | 명사(주제 핵심 용어) | 가입 (한자 없음) | (topic-specific) | `가입`는 `수업 준비 1: 필수 플랫폼 가입/계정 설정 (class001)` 실습에서 코드 구조와 실행 결과를 안정적으로 만들기 위한 핵심 용어입니다. |
| `계정` | 명사(주제 핵심 용어) | 계정 (한자 없음) | (topic-specific) | `계정`는 `수업 준비 1: 필수 플랫폼 가입/계정 설정 (class001)` 실습에서 코드 구조와 실행 결과를 안정적으로 만들기 위한 핵심 용어입니다. |
| `설정` | 명사(주제 핵심 용어) | 설정 (한자 없음) | (topic-specific) | `설정`는 `수업 준비 1: 필수 플랫폼 가입/계정 설정 (class001)` 실습에서 코드 구조와 실행 결과를 안정적으로 만들기 위한 핵심 용어입니다. |
| `Python` | 고유명사(언어명) | Python (한자 없음) | Python | 데이터 처리와 AI 실습에 널리 쓰이는 범용 프로그래밍 언어입니다. |
