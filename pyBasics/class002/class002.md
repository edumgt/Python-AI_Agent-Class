...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `수업 준비 2: 필수 소프트웨어 설치 (class002) · 단계 1/1 입문 이해 [class002]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `필수` | 명사(기술 개념어) | 필수 (한자 없음) | (context-specific) | 용어 `필수`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
| `소프트웨어` | 명사(기술 개념어) | 소프트웨어 (한자 없음) | (context-specific) | 용어 `소프트웨어`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
| `설치` | 명사(기술 개념어) | 설치 (한자 없음) | (context-specific) | 용어 `설치`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
| `class002` | 영문 기술명/약어 | class002 (한자 없음) | class002 | 용어 `class002`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |
