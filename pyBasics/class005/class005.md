...
## 1) 오늘의 학습 정보
- 교과목: **Python 프로그래밍**
- 학습 주제: **변수와 자료형 · 단계 1/4 입문 이해 [class005]**
- 학습 주제 진행: **변수와 자료형 · 단계 1/4 입문 이해 [class005] (총 4시간 중 1시간차)**
- 세부 시퀀스: **5/40**
- 일정: **Day 01 / 5교시**
...
#### 학습주제 표현 분석: `변수와 자료형 · 단계 1/4 입문 이해 [class005]`
- 문법 포인트: 명사와 명사를 대등하게 묶는 병렬 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `변수와 자료형 · 단계 1/4 입문 이해 [class005]`를 중심으로 같은 주제 내에서 단계적으로 고도화된 구현을 수행합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class004 / Python 기초 시작: 변수와 출력 첫 실행 (class004) · 단계 1/1 입문 이해 [class004]** (Day 01 / 4교시)
- 복습 연결: 이전에 배운 **Python 기초 시작: 변수와 출력 첫 실행 (class004) · 단계 1/1 입문 이해 [class004]** 를 떠올리며, 오늘 **변수와 자료형 · 기초 정리 모듈 경계 설정 (차시 05) [class005]** 와 어떤 점이 이어지는지 비교해 보세요.

## 3) 주제를 아주 쉽게 이해하기
- 한 줄 설명: 변수와 자료형를 단계 1/4(입문 이해) 수준으로 고도화해 구현하는 차시입니다.
- 왜 배우나요?: 동일 주제를 반복하더라도 단계별 난이도를 높여 실무 수준의 문제 해결력을 만들기 위해서입니다.

### 핵심 개념 3가지
1. `변수와 자료형`의 핵심 입력/출력 구조를 단계 1/4 기준으로 명확히 정의합니다.
...
N2["학습 주제 파악: 변수와 자료형 · 단계 1/4 입문 이해 [class005]"]
...
### 실습 미션
1. `변수와 자료형` 단계 1/4 목표 기능을 코드로 구현하고 실행 로그를 남기세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class006 / 변수와 자료형 · 단계 2/4 기초 구현 [class006]** (Day 01 / 6교시)
- 미리보기: 다음 차시 전에 **변수와 자료형 · 단계 1/4 입문 이해 [class005]** 핵심 코드 1개를 다시 실행해 두면 변수와 자료형 · 단계 2/4 기초 구현 [class006] 학습이 더 쉬워집니다.
