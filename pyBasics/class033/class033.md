...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class032 / 예외처리와 디버깅** (Day 04 / 8교시)
- 복습 연결: 이전에 배운 **예외처리와 디버깅** 를 떠올리며, 오늘 **객체지향 기초** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class034 / 객체지향 기초** (Day 05 / 2교시)
