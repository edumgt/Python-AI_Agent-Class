...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `Python 외부 라이브러리 활용 · 단계 2/2 운영 최적화 [class034]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
| `Python` | 고유명사(언어명) | Python (한자 없음) | Python | 데이터 처리와 AI 실습에 널리 쓰이는 범용 프로그래밍 언어입니다. |
| `외부` | 명사(기술 개념어) | 외부 (한자 없음) | (context-specific) | 용어 `외부`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
| `라이브러리` | 명사(기술 개념어) | 라이브러리 (한자 없음) | (context-specific) | 용어 `라이브러리`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
...
- 복습 연결: 이전에 배운 **Python 외부 라이브러리 활용 · 단계 1/2 입문 이해 [class033]** 를 떠올리며, 오늘 **Python 외부 라이브러리 활용 · 단계 2/2 운영 최적화 [class034]** 와 어떤 점이 이어지는지 비교해 보세요.
