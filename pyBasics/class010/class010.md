...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class009 / 연산자와 조건문** (Day 02 / 1교시)
...
## 5) 오늘의 예제 코드
- 예제 파일: `class010_example.py`
- 실행 명령:
```bash
python pyBasics/class010/class010_example.py
```
...
python3 pyBasics/class010/class010_example.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python pyBasics/class010/class010_example.py`)
...
N7["예제 실행: python pyBasics/class010/class010_example.py"]
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class011 / 연산자와 조건문** (Day 02 / 3교시)
