...
## 1) 오늘의 학습 정보
- 교과목: **Python 프로그래밍**
- 학습 주제: **수업 준비 3: 개발환경 검증/실행 확인 (class003) · 단계 1/1 입문 이해 [class003]**
- 학습 주제 진행: **수업 준비 3: 개발환경 검증/실행 확인 (class003) · 단계 1/1 입문 이해 [class003] (총 1시간 중 1시간차)**
- 세부 시퀀스: **3/40**
- 일정: **Day 01 / 3교시**
...
#### 학습주제 표현 분석: `수업 준비 3: 개발환경 검증/실행 확인 (class003) · 단계 1/1 입문 이해 [class003]`
- 문법 포인트: 명사구를 연결어 '및'으로 병렬 연결한 구조입니다. 동등한 학습 범위를 함께 제시합니다.
- 기술 포인트: 이번 차시는 `수업 준비 3: 개발환경 검증/실행 확인 (class003) · 단계 1/1 입문 이해 [class003]`를 중심으로 같은 주제 내에서 단계적으로 고도화된 구현을 수행합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class002 / 수업 준비 2: 필수 소프트웨어 설치 (class002) · 단계 1/1 입문 이해 [class002]** (Day 01 / 2교시)
- 복습 연결: 이전에 배운 **수업 준비 2: 필수 소프트웨어 설치 (class002) · 단계 1/1 입문 이해 [class002]** 를 떠올리며, 오늘 **오리엔테이션 및 개발환경 준비 · 기초 정리 데이터 스키마 점검 (차시 03) [class003]** 와 어떤 점이 이어지는지 비교해 보세요.

## 3) 주제를 아주 쉽게 이해하기
- 한 줄 설명: 수업 준비 3: 개발환경 검증/실행 확인 (class003)를 단계 1/1(입문 이해) 수준으로 고도화해 구현하는 차시입니다.
- 왜 배우나요?: 동일 주제를 반복하더라도 단계별 난이도를 높여 실무 수준의 문제 해결력을 만들기 위해서입니다.

### 핵심 개념 3가지
1. `수업 준비 3: 개발환경 검증/실행 확인 (class003)`의 핵심 입력/출력 구조를 단계 1/1 기준으로 명확히 정의합니다.
...
## 5) 오늘의 예제 코드
- 예제 파일: `class003_example1.py`
- 실행 명령:
```bash
python pyBasics/class003/class003_example1.py
```
...
python3 pyBasics/class003/class003_example1.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python pyBasics/class003/class003_example1.py`)
- 주요 문법: `모듈 import`, `변수 할당`, `실행 진입점(__name__)`, `출력(print)`
- 학습 포커스: `수업 준비 3: 개발환경 검증/실행 확인 (class003) · 단계 1/1 입문 이해 [class003]`

### 실습 example1.py 동작 원리 (Mermaid Flowchart)
```mermaid
flowchart TD
N1["시작: class003 (3/40, 입문)"]
N2["학습 주제 파악: 수업 준비 3: 개발환경 검증/실행 확인 (class003) · 단계 1/1 입문 이해 [class003]"]
...
N7["예제 실행: python pyBasics/class003/class003_example1.py"]
...
### 실습 미션
1. `수업 준비 3: 개발환경 검증/실행 확인 (class003)` 단계 1/1 목표 기능을 코드로 구현하고 실행 로그를 남기세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class004 / Python 기초 시작: 변수와 출력 첫 실행 (class004) · 단계 1/1 입문 이해 [class004]** (Day 01 / 4교시)
- 미리보기: 다음 차시 전에 **수업 준비 3: 개발환경 검증/실행 확인 (class003) · 단계 1/1 입문 이해 [class003]** 핵심 코드 1개를 다시 실행해 두면 Python 기초 시작: 변수와 출력 첫 실행 (class004) · 단계 1/1 입문 이해 [class004] 학습이 더 쉬워집니다.
