...
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `수업 준비 3: 개발환경 검증/실행 확인 (class003) · 단계 1/1 입문 이해 [class003]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
| `수업` | 명사(기술 개념어) | 수업 (한자 없음) | (context-specific) | 용어 `수업`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
...
| `실행` | 명사(기술 개념어) | 실행 (한자 없음) | (context-specific) | 용어 `실행`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
| `확인` | 명사(기술 개념어) | 확인 (한자 없음) | (context-specific) | 용어 `확인`: 이번 학습주제에서 정의해야 할 핵심 개념 용어입니다. |
