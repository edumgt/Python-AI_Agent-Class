...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class400 / PromptTemplate** (Day 50 / 8교시)
...
- 실행 명령:
```bash
python class401/class401_example.py
```

<!-- AUTO-GENERATED: TECH_STACK_FLOW START -->
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python class401/class401_example.py`)
...
N7["예제 실행: python class401/class401_example.py"]
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class402 / PromptTemplate** (Day 51 / 2교시)
