...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class176 / 음성 데이터 구조 이해** (Day 22 / 8교시)
- 복습 연결: 이전에 배운 **음성 데이터 구조 이해** 를 떠올리며, 오늘 **오디오 전처리** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class178 / 오디오 전처리** (Day 23 / 2교시)
- 미리보기: 다음 차시 전에 **오디오 전처리** 핵심 코드 1개를 다시 실행해 두면 오디오 전처리 학습이 더 쉬워집니다.
