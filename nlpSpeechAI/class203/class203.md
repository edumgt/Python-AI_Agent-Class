...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class202 / 시퀀스 모델 기초** (Day 26 / 2교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class204 / 시퀀스 모델 기초** (Day 26 / 4교시)
- 미리보기: 다음 차시 전에 **시퀀스 모델 기초** 핵심 코드 1개를 다시 실행해 두면 시퀀스 모델 기초 학습이 더 쉬워집니다.
