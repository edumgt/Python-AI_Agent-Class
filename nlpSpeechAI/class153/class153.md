...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class152 / 텍스트 정제와 토큰화** (Day 19 / 8교시)
- 복습 연결: 이전에 배운 **텍스트 정제와 토큰화** 를 떠올리며, 오늘 **임베딩 기초** 와 어떤 점이 이어지는지 비교해 보세요.
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class154 / 임베딩 기초** (Day 20 / 2교시)
- 미리보기: 다음 차시 전에 **임베딩 기초** 핵심 코드 1개를 다시 실행해 두면 임베딩 기초 학습이 더 쉬워집니다.
