...
#### 학습주제 표현 분석: `NLP/STT/TTS 개요`
- 문법 포인트: 핵심 개념 명사를 중심으로 한 명사구 구조입니다.
- 기술 포인트: 이번 차시는 `NLP/STT/TTS 개요` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class128 / 실전 예측 미니 프로젝트** (Day 16 / 8교시)
- 복습 연결: 이전에 배운 **실전 예측 미니 프로젝트** 를 떠올리며, 오늘 **NLP/STT/TTS 개요** 와 어떤 점이 이어지는지 비교해 보세요.
...
- 학습 포커스: `NLP/STT/TTS 개요`

### 실습 example.py 동작 원리 (Mermaid Flowchart)
```mermaid
flowchart TD
N1["시작: class129 (1/96, 입문)"]
N2["학습 주제 파악: NLP/STT/TTS 개요"]
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class130 / NLP/STT/TTS 개요** (Day 17 / 2교시)
