...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class175 / 음성 데이터 구조 이해** (Day 22 / 7교시)
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class177 / 오디오 전처리** (Day 23 / 1교시)
- 미리보기: 다음 차시 전에 **음성 데이터 구조 이해** 핵심 코드 1개를 다시 실행해 두면 오디오 전처리 학습이 더 쉬워집니다.
