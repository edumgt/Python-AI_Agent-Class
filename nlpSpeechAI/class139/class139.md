...
## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class138 / 텍스트 데이터 수집** (Day 18 / 2교시)
...
## 5) 오늘의 예제 코드
- 예제 파일: `class139_example.py`
- 실행 명령:
```bash
python nlpSpeechAI/class139/class139_example.py
```
...
python .\nlpSpeechAI\class139\class139_example.py
...
python3 nlpSpeechAI/class139/class139_example.py
...
### 기술 스택
- 언어: `Python 3`
- 실행: `CLI` (`python nlpSpeechAI/class139/class139_example.py`)
...
N7["예제 실행: python nlpSpeechAI/class139/class139_example.py"]
...
## 10) 학습 후 다음에 배울 내용
- 다음 차시: **class140 / 텍스트 데이터 수집** (Day 18 / 4교시)
