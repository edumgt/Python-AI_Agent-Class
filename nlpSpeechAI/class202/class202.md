...
- 기술 포인트: 이번 차시는 `시퀀스 모델 기초 · 단계 2/8 기초 구현 [class202]` 용어를 중심으로 문제 정의, 코드 구현, 결과 검증까지 연결합니다.
| 용어 | 문법/품사 | 한글·한자 | 영어 | 기술 설명 |
| --- | --- | --- | --- | --- |
...
| `class202` | 영문 기술명/약어 | class202 (한자 없음) | class202 | 용어 `class202`: 이번 차시에서 쓰이는 핵심 기술 용어입니다. |

## 2) 이전에 배운 내용 (복습)
- 이전 차시: **class201 / 시퀀스 모델 기초 · 단계 1/8 입문 이해 [class201]** (Day 26 / 1교시)
- 복습 연결: 이전에 배운 **시퀀스 모델 기초 · 단계 1/8 입문 이해 [class201]** 를 떠올리며, 오늘 **시퀀스 모델 기초 · 단계 2/8 기초 구현 [class202]** 와 어떤 점이 이어지는지 비교해 보세요.
