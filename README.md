...
2. Python 코드 백엔드 + 바닐라 html FE 의 멀티모달 Serving
3. 모델 호출/파이프라인 설계, 클라우드 기반, On Prem 환경 기반 ( Docker, k8s 응용 )
4. LangChain/RAG 아키텍처 이해
...
3. 학생 각자 개인별 repo 를 20개 이상 구성 하여, 빌드업, 개인 취업 용 증적으로 사용
